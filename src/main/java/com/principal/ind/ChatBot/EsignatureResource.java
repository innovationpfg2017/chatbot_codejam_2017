...
public class EsignatureResource {
	...
	public WebhookResponse processEsignature(String jsonString) throws Exception{
		...
		String resopnse = "You will receive a mail shortly on your registered email id. Please follow the instructions given in the mail to confirm the change. Thank you for being our valuable customer.";
